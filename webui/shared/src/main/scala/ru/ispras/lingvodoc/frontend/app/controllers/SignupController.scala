...
class SignupController(scope: SignupScope, location: Location, backend: BackendService, val timeout: Timeout, val exceptionHandler: ExceptionHandler) extends AbstractController[SignupScope](scope) with AngularExecutionContextProvider {
