...
snapshots['TestConnection.test_USE_BANHAMMER 1'] = {
    'data': {
...
snapshots['TestConnection.test_create_entity_user_header 1'] = {
    ...
    'errors': [
        {
            'message': "Client 4 doesn't have 'create' permissions for 'lexical_entries_and_entities' (2, 3)."
        }
    ]
}
...
snapshots['TestConnection.test_update_entity_user_header 1'] = {
    ...
    'errors': [
        {
            'message': "Client 4 doesn't have 'create' permissions for 'approve_entities' (2, 3)."
        }
    ]
}
...
snapshots['TestConnection.test_delete_entity_owner_header 1'] = {
    ...
    'errors': [
        {
            'message': "Client 4 doesn't have 'delete' permissions for 'lexical_entries_and_entities' (2, 3)."
        }
    ]
}
...
snapshots['TestConnection.test_delete_gist_owner_header 1'] = {
    ...
    'errors': [
        {
            'message': "Client 4 doesn't have 'delete' permissions for 'translations' [4, 7]."
        }
    ]
}
...
snapshots['TestConnection.test_update_atom_owner_header 1'] = {
    ...
    'errors': [
        {
            'message': "Client 4 doesn't have 'edit' permissions for 'translations' [4, 8]."
        }
    ]
}
