...
class TestDictionariesListSuccessCondition(unittest.TestCase):
    def setUp(self):
        ...
        with transaction.manager:
            ...
            new_lang2 = Language(client_id=1, object_id=2, translation_string='left son', parent=new_lang1)
            ...
            new_lang4 = Language(client_id=1, object_id=4, translation_string='first grand son', parent=new_lang3)
            ...
            new_dict4 = Dictionary(client_id=5, object_id=1, name='test3', parent=new_lang9)
            DBSession.add(new_dict4)
            new_dict5 = Dictionary(client_id=4, object_id=1, name='test3', parent=new_lang10)
    ...
    def test_language_filter(self):
        ...
        response = self.app.post_json('/dictionaries', params={'language_client_id':1, 'language_object_id':3})
