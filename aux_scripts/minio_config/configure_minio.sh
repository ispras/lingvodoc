...
# add group for listing operations
mc admin group add minio lingvodoc username # repeat 4 times for each users
...
mc admin policy add minio lingvodoc_temp_objects_listing_for_group ./lingvodoc_temp_objects_listing_for_group.json
...
mc admin policy set "minio/lingvodoc-temp-files/staging/*" lingvodoc_temp_objects_rw_staging user=lingvodoc_temp_objects_rw_staging
mc admin policy set minio lingvodoc_temp_objects_rw_dev user=lingvodoc_temp_objects_rw_dev
mc admin policy set minio lingvodoc_temp_objects_listing_for_group group=lingvodoc
