...
Revision ID: 2c16f0c33d9
Revises: 
Create Date: 2016-07-21 13:58:25.499971

"""

# revision identifiers, used by Alembic.
revision = '2c16f0c33d9'
down_revision = None
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('additional_metadata', sa.UnicodeText(), nullable=True),
    sa.Column('linked_to_client_id', sa.BigInteger(), nullable=True),
    sa.Column('linked_to_object_id', sa.BigInteger(), nullable=True),
    ...
    op.create_table('lexicalentry_to_lexicalentry_association',
    sa.Column('lexicalentry_1_client_id', sa.BigInteger(), nullable=True),
    sa.Column('lexicalentry_1_object_id', sa.BigInteger(), nullable=True),
    sa.Column('lexicalentry_2_client_id', sa.BigInteger(), nullable=True),
    sa.Column('lexicalentry_2_object_id', sa.BigInteger(), nullable=True),
    sa.ForeignKeyConstraint(['lexicalentry_1_client_id', 'lexicalentry_1_object_id'], ['lexicalentry.client_id', 'lexicalentry.object_id'], ),
    sa.ForeignKeyConstraint(['lexicalentry_2_client_id', 'lexicalentry_2_object_id'], ['lexicalentry.client_id', 'lexicalentry.object_id'], )
    )
...
def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('lexicalentry_to_lexicalentry_association')
