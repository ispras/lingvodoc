...
Revision ID: 26e53054660
Revises: 2f2626d699
Create Date: 2015-09-16 17:10:23.821240

"""

# revision identifiers, used by Alembic.
revision = '26e53054660'
down_revision = '2f2626d699'
...
def upgrade():
    ...
    sa.Column('readable_name', sa.UnicodeText(), nullable=True),
    ...
    sa.Column('translation_string', sa.UnicodeText(length=2147483648), nullable=True),
    ...
    sa.Column('translation_string', sa.UnicodeText(length=2147483648), nullable=True),
    sa.Column('translation', sa.UnicodeText(length=2147483648), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('name', sa.UnicodeText(length=2147483648), nullable=True),
    sa.Column('marked_for_deletion', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['parent_object_id', 'parent_client_id'], ['language.object_id', 'language.client_id'], ),
    sa.PrimaryKeyConstraint('object_id', 'client_id')
    )
    ...
    sa.Column('intl_name', sa.UnicodeText(length=2147483648), nullable=True),
    sa.ForeignKeyConstraint(['parent_object_id', 'parent_client_id'], ['language.object_id', 'language.client_id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('id', lingvodoc.models.SLBigInteger(), nullable=False),
    sa.Column('login', sa.UnicodeText(length=30), nullable=True),
    sa.Column('name', sa.UnicodeText(), nullable=True),
    ...
    sa.Column('dictionaries', sa.BigInteger(), nullable=True),
    sa.Column('languages', sa.BigInteger(), nullable=True),
    sa.Column('fields', sa.BigInteger(), nullable=True),
    sa.Column('perspectives', sa.BigInteger(), nullable=True),
    sa.Column('uets', sa.BigInteger(), nullable=True),
    sa.Column('lexentr', sa.BigInteger(), nullable=True),
    sa.Column('levoneentity', sa.BigInteger(), nullable=True),
    sa.Column('levtwoentity', sa.BigInteger(), nullable=True),
    sa.Column('groupentity', sa.BigInteger(), nullable=True),
    ...
    sa.Column('entity_type', sa.UnicodeText(length=2147483648), nullable=True),
    sa.Column('data_type', sa.UnicodeText(), nullable=True),
    sa.Column('level', sa.UnicodeText(), nullable=True),
    sa.Column('group', sa.UnicodeText(length=2147483648), nullable=True),
    sa.Column('marked_for_deletion', sa.Boolean(), nullable=True),
    sa.Column('state', sa.UnicodeText(), nullable=True),
    ...
    sa.Column('id', lingvodoc.models.SLBigInteger(), nullable=False),
    sa.Column('user_id', sa.BigInteger(), nullable=True),
    sa.Column('email', sa.UnicodeText(length=50), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('id', lingvodoc.models.SLBigInteger(), nullable=False),
    sa.Column('user_id', sa.BigInteger(), nullable=True),
    sa.Column('hash', sa.UnicodeText(length=61), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('content', sa.UnicodeText(length=2147483648), nullable=True),
    sa.Column('additional_metadata', sa.UnicodeText(length=2147483648), nullable=True),
