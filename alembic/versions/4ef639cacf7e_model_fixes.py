...
def downgrade():
    ...
    op.alter_column('lexicalentry', 'marked_for_deletion',
                    existing_type=sa.BOOLEAN(),
                    nullable=True)
    op.create_foreign_key('entity_link_client_id_fkey', 'entity', 'lexicalentry', ['link_client_id', 'link_object_id'],
                          ['client_id', 'object_id'])
    op.create_foreign_key('dictionaryperspectivetofield_link_client_id_fkey', 'dictionaryperspectivetofield',
                          'dictionaryperspective', ['link_client_id', 'link_object_id'], ['client_id', 'object_id'])
    # ### end Alembic commands ###
